...
private static Log log = LogFactory.getLog(UserInfoController.class);
	 ...
	 * 
	 */
	@RequestMapping("page/admin/listUserInfo")
	public String listUserInfo(String username,HttpServletResponse response) {
		try {
			Map<String, Object> paramMap = new HashMap<String, Object>(); // 业务条件查询参数
			paramMap.put("username",username); // 用户登录名（精确查询）
			PageBean pageBean = userInfoFacade.listPage(new PageParam(1,10), paramMap);
			Long total=userInfoFacade.getTotal(paramMap);
